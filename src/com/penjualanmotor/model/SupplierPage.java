...
import com.penjualanmotor.service.AddSupplier;
import com.penjualanmotor.service.UpdateSupplier;
...
public class SupplierPage extends javax.swing.JFrame {
    ...
    private void getSupplierTable() {
        Object[] Baris = {"ID","Nama Supplier","No. Telepon"};
        Tab = new DefaultTableModel(null, Baris);      
        try {
            Res = Con.querySelectWith("supplier", "nama_supplier LIKE '%"+searchField.getText()+ "%' ORDER BY id_supplier ASC");
            while (Res.next()) {
    ...
    private void deleteCustomer() {
        ...
        String condition = "id_supplier = '"+String.valueOf(supplierTable.getValueAt(supplierTable.getSelectedRow(), 0))+"'";
    ...
    private void getPopUpSupplier() {
        UpdateSupplier customer = new UpdateSupplier();
        customer.id = supplierTable.getValueAt(supplierTable.getSelectedRow(), 0).toString();;
        customer.nama = supplierTable.getValueAt(supplierTable.getSelectedRow(), 1).toString();
        customer.noTelepon = supplierTable.getValueAt(supplierTable.getSelectedRow(), 2).toString();
        customer.getSupplierData();
    ...
    private void getPrint() {
        ...
        try{   
            ...
            String path = "src/com/penjualanmotor/report/supplier.jasper";        
    ...
    private void setUI() {
        supplierPanel.setBackground(new Color(68, 80, 105));
