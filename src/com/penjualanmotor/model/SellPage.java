...
import com.penjualanmotor.service.AddSell;
import com.penjualanmotor.service.LoginPage;
import com.penjualanmotor.service.UpdateSell;
...
public class SellPage extends javax.swing.JFrame {
    ...
    private void getSellTable() {
        Object[] Baris = {"ID","Tipe","No Plat","Harga","Nama Customer","No. Telepon"};
        Tab = new DefaultTableModel(null, Baris);      
        try {
            Res = Con.querySelectWith("transaksi", "tipe_motor LIKE '%"+searchField.getText()+ "%' ORDER BY id_transaksi ASC");
            while (Res.next()) {
    ...
    private void getPopUpSell() {
        UpdateSell sell = new UpdateSell();
        sell.id = sellTable.getValueAt(sellTable.getSelectedRow(), 0).toString();
        sell.tipeMotor = sellTable.getValueAt(sellTable.getSelectedRow(), 1).toString();
        sell.noPlat = sellTable.getValueAt(sellTable.getSelectedRow(), 2).toString();
        sell.hargaMotor = sellTable.getValueAt(sellTable.getSelectedRow(), 3).toString();
        sell.namaCustomer = sellTable.getValueAt(sellTable.getSelectedRow(), 4).toString();
        sell.noTelepon = sellTable.getValueAt(sellTable.getSelectedRow(), 5).toString();
        sell.getSellData();
    ...
    private void deleteSell() {
        ...
        String condition = "id_transaksi = '"+String.valueOf(sellTable.getValueAt(sellTable.getSelectedRow(), 0))+"'";
    ...
    private void getPrint() {
        ...
        try{   
            ...
            String path = "src/com/penjualanmotor/report/sell.jasper";        
    ...
    private void setButton() {
        ...
        editButton.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (sellTable.isRowSelected(row)) {
                    getPopUpSell();    
                }
                else {
    ...
    private void setUI() {
        sellPanel.setBackground(new Color(68, 80, 105));
    ...
    private void initComponents() {
        ...
        sellTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Tipe", "No Plat", "Harga", "Nama Customer", "No. Telepon"
            }
        ));
