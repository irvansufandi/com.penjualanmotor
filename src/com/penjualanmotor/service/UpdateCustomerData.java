 ...
 * @author Irvansfd
 */
public class UpdateCustomerData extends javax.swing.JFrame {
    private ConnectDB Con;
    private ResultSet Res;
    private DefaultTableModel Tab;
    public UpdateSell getUpdateCustomer = null;

    /**
     * Creates new form UpdateCustomerData
     */
    ...
    public void getValue() {
        getUpdateCustomer.namaCustomer = customerTable.getValueAt(customerTable.getSelectedRow(), 1).toString();
        getUpdateCustomer.noTelepon = customerTable.getValueAt(customerTable.getSelectedRow(), 2).toString();
        getUpdateCustomer.getDataCustomer(); 
        this.dispose();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateCustomerData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateCustomerData().setVisible(true);
            }
        });
    }
