 ...
 * @author Irvansfd
 */
public class AddSellData extends javax.swing.JFrame {
    private ConnectDB Con;
    private ResultSet Res;
    private DefaultTableModel Tab;
    public AddSend getSellData = null;
    /**
     * Creates new form AddSellData
     */
    public AddSellData() {
    ...
    public void getAddValue() {
        getSellData.tipeMotor = sellTable.getValueAt(sellTable.getSelectedRow(), 0).toString();
        getSellData.noPlat = sellTable.getValueAt(sellTable.getSelectedRow(), 1).toString();
        getSellData.nama = sellTable.getValueAt(sellTable.getSelectedRow(), 3).toString();
        getSellData.noTelepon = sellTable.getValueAt(sellTable.getSelectedRow(), 4).toString();
        getSellData.getDataSell();
        this.dispose();
    }
    ...
    public void setButton() {
        ...
        sellTable.addMouseListener(new MouseListener() {
            @Override
            public void mouseClicked(MouseEvent e) {
                getAddValue();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddSellData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddSellData().setVisible(true);
            }
        });
    }
